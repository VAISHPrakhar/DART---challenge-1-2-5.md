...
![logo](assets/logo/á‰€áŒ£áˆª-logos_white_readme.png)
...
* The billboards use too much paperwork and other resources. It also wastes the countryâ€™s infrastructure.
...
> Recruiters and companies will be asked to write a detailed description of the kind of job to be performed and what kind of person they think will do that job adequately and this detailed information will be transparent to job seekers to evaluate themselves and the job to make sure theyâ€™re applying and being well informed in doing so.
5. The System must allow job seekers to apply for and withdraw from job openings 
> Job seekers should have the freedom to apply to any job they think will fit them and withdraw their application whenever possible. This will make our job seekers comfortable in applying to jobs and not feel like theyâ€™re imprisoned just because they applied.
...
> All external communications between the dataâ€™s server and client must be encrypted
