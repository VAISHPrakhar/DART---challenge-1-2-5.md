...
function insertJobs(){ 
    ...
    fetch('../rozgr/src/php/jobOut.php',{
        method: 'POST'
...
let emailSubscriptionBody = "You've successfully signed up for rozgr's email subscription!";
function subscribeEmail(){
    ...
    if(userEmail != ""){
        ...
        window.open("mailto:" + userEmail + "?subject=rozgr.com&body=" + emailSubscriptionBody);
    }
}
